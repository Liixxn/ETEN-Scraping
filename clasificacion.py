...
def leerRecetasUnlabeled():
    df_recetas_online = pd.read_csv("recetas_csv/df_recetas_gratis_v2.csv", sep=";")
...
df_recetas = pd.read_csv("recetas_csv/df_recetas_gratis_v2.csv", sep=";")
df_recetas["Categoria"] = listaPredicciones
df_recetas.to_csv("prediciones/df_recetas_gratis_prediccion.csv", sep=";", index=False)
