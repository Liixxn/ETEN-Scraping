...
# API_KEY = 'AIzaSyDaeZe-w0elhvW4LgmKONXcxp2SDzXFbWk' #ETEN 7 V4
# API_KEY = 'AIzaSyBcVu9GY6jSx-fpbf9t_qL1dLR-9Tu9fR8' #ETEN 8 V4
# API_KEY = 'AIzaSyBHP8l4xIiRUURtrx0Vl3DzFYr64kx8XP8' #ETEN 9 V4
# API_KEY = 'AIzaSyBVKSVzEcr7gpPq3LpfmRr4KQUcux_zoDg' #ETEN 10 V4
# API_KEY = 'AIzaSyDG5lJfsV9xAyL8WcKvQ53Cb555wBwUN7k' #ETEN 11 V4
# API_KEY = 'AIzaSyCV-zG7pq_Vn-Q8hYaPs2RePV5wHTXSd6I' #ETEN 12 V4
# API_KEY = 'AIzaSyCMOcxe2amdLpvyY1DGzRHRKo_cBENoOR0' #ETEN 1 V5
# API_KEY = 'AIzaSyCwMhbsrN4G7fjvvIKl7-Z_H16PZ90DuOE' #ETEN 2 V5
