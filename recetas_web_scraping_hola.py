...
def scrapingPorCategoria(todas_categorias_hola):
    ...
    url_categoria_hola = todas_categorias_hola[1]  # categoria_actual
    nombre_categoria_seleccionada = nombres_categorias[1]  # iteradorCategoria
...
df.to_csv('df_hola_final.csv', index=False, sep=';')
