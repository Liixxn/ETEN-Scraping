...
def scrapingPorCategoria(todas_categorias_hola):
    ...
    url_categoria_hola = todas_categorias_hola[18]  # categoria_actual
    nombre_categoria_seleccionada = nombres_categorias[18]  # iteradorCategoria
...
df.to_csv('df_hola_final_18.csv', index=False, sep=';')
